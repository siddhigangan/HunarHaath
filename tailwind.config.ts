	...
	theme: {
		...
		extend: {
			colors: {
				...
				nature: {
					'bamboo': '#8B9A46',       // Main bamboo color
					'moss': '#606C38',         // Deep moss green
					'leaf': '#557153',         // Fresh leaf color 
					'olive': '#4F772D',        // Rich olive tone
					'earth': '#7F4F24',        // Earthy brown
					'bark': '#5E4C3F',         // Bamboo bark brown
					'sage': '#A3B18A',         // Soft sage green
					'linen': '#F0EAD2',        // Natural linen beige
					'cream': '#F9F7F0',        // Soft cream
					'sand': '#DDA15E',         // Warm sand color
					'sunlight': '#FEFAE0'      // Gentle sunlight yellow
				}
			},
			borderRadius: {
				lg: 'var(--radius)',
			...
			animation: {
				...
				'leaves-fall': 'leaves-fall 10s ease-in-out infinite'
			},
			fontFamily: {
			...
			backgroundImage: {
				...
				'bamboo-pattern': "url('data:image/svg+xml,%3Csvg width=\"60\" height=\"60\" viewBox=\"0 0 60 60\" xmlns=\"http://www.w3.org/2000/svg\"%3E%3Cpath d=\"M54.627 0l.83.828-1.415 1.415L51.8 0h2.827zM5.373 0l-.83.828L5.96 2.243 8.2 0H5.374zM48.97 0l3.657 3.657-1.414 1.414L46.143 0h2.828zM11.03 0L7.372 3.657l1.415 1.414L13.857 0H11.03zm32.284 0L49.8 6.485 48.384 7.9l-7.9-7.9h2.83zm-24.596 0l-5.485 5.486 1.414 1.414 7.9-7.9h-2.83zm16.485 0l-4.242 4.242L29.8 2.12v-.12h5.374zm-8.323 0l4.242 4.242L29.8 2.12v-.12h2.122z\" fill=\"%23606C38\" fill-opacity=\"0.1\" fill-rule=\"evenodd\"/%3E%3C/svg%3E')",
				'nature-gradient': "linear-gradient(to bottom, rgba(255, 255, 255, 0) 0%, rgba(243, 244, 234, 0.7) 75%, rgba(243, 244, 234, 1) 100%)",
			},
			boxShadow: {
