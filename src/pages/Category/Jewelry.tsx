...
export default function JewelryCategory() {
  const [filteredProducts, setFilteredProducts] = useState(products.filter(product => product.category === "Jewelry"));
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-craft-forest/80 max-w-3xl">
            Discover unique, handcrafted jewelry pieces made by skilled artisans. 
            Each piece tells a story and adds a special touch to your style.
          </p>
        </div>
              ...
              <div className="mb-6">
                ...
                <div className="space-y-2">
                  <div className="flex items-center">
                    <input type="checkbox" id="silver" className="mr-2 h-4 w-4" />
                    <label htmlFor="silver">Sterling Silver</label>
                  </div>
                  <div className="flex items-center">
                    <input type="checkbox" id="gold" className="mr-2 h-4 w-4" />
                    <label htmlFor="gold">Gold</label>
                  </div>
                  <div className="flex items-center">
                    <input type="checkbox" id="copper" className="mr-2 h-4 w-4" />
                    <label htmlFor="copper">Copper</label>
                  </div>
                  <div className="flex items-center">
                    <input type="checkbox" id="gemstone" className="mr-2 h-4 w-4" />
                    <label htmlFor="gemstone">Gemstones</label>
                  </div>
                </div>
              </div>
          ...
          <div className="flex-1">
            ...
            {filteredProducts.length === 0 && (
              <div className="text-center py-12">
                ...
                <Button 
                  onClick={() => setFilteredProducts(products.filter(product => product.category === "Jewelry"))}
