    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="text-sm breadcrumbs mb-6">
        <ul className="flex items-center space-x-2">
          ...
          <li><span className="font-medium">Clothing</span></li>
        </ul>
      </div>

      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl md:text-4xl font-serif text-craft-forest mb-2">Handcrafted Clothing</h1>
        <p className="text-craft-forest/80 max-w-3xl">
          Discover unique clothing pieces crafted by talented artisans. Each piece tells a story of tradition and craftsmanship.
        </p>
      </div>
